...
function TeachingEngineering() {
  ...
  return (
    <div className='Business'>
      ...
      <NavLink to='/teaching/engineering' className='sub-link'  style={{marginLeft:'140px'}}>Engineering</NavLink>
        ...
        <div className='BusinessSection'>
            ...
            <div className='main'>
                <div className='box'>
                {ContextData.filter((item) => item && item.id === 240).map((item, index) => {
            console.log(item);
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 239).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 238).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 237).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 236).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
...
<div className='box1'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 230).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
...
export default TeachingEngineering;
