...
<div className='box1'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 207).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 208).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 209).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 210).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
