...
function HealthSport() {
  ...
  return (
    <div className='Business'>
      ...
      <div><h3>Health & Fitness Courses &gt;</h3></div>
      <div className="sub-nav">
      <NavLink to='/health/fitness' className='sub-link'  style={{marginLeft:'140px'}}>Fitness</NavLink>
        <NavLink to='/health/yoga' className='sub-link'>Yoga</NavLink>
        <NavLink to='/health/mental' className='sub-link'>Mental Health</NavLink>
        <NavLink to='/health/sport' className='sub-link'>Sports</NavLink>
        <NavLink to='/health' className='sub-link'>Good Health</NavLink>
        </div>
        </div>

        <div className='BusinessSection'>
            <div className='BusinessSectionHead'>
            <h1>Health & Fitness Courses</h1>
            ...
            <div className='main'>
                <div className='box'>
                {ContextData.filter((item) => item && item.id === 215).map((item, index) => {
            console.log(item);
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 214).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 213).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 212).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 211).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
...
<div className='BusinessSection3Inner'>
    <div>Yoga</div>
    <div>Nutrition</div>
    <div>CBT Cognitive Behavioural Therapy</div>
    <div>Meditation</div>
    <div>Qi Gong</div>
    <div>Massage</div>
    <div>Fitness</div>
...
<div className='box1'>
                {ContextData.filter((item) => item && item.id === 206).map((item, index) => {
            console.log(item);
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 205).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 203).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 202).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 200).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 201).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 204).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
