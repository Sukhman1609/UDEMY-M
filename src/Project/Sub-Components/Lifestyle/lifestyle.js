...
function Lifestyle() {
  ...
  return (
    <div className='Business'>
      ...
      <div><h3>Life Style Courses &gt;</h3></div>
      <div className="sub-nav">
      <NavLink to='/lifestyle/arts' className='sub-link'>Arts & Crafts</NavLink>
        <NavLink to='/lifestyle/beauty' className='sub-link'>Beauty & Makeup</NavLink>
        <NavLink to='/lifestyle/food' className='sub-link'>Food & Beverage</NavLink>
        <NavLink to='/lifestyle/pet' className='sub-link'>Pet Care & Training</NavLink>
        <NavLink to='/lifestyle' className='sub-link'>Travel</NavLink>
        </div>
        </div>

        <div className='BusinessSection'>
            <div className='BusinessSectionHead'>
            <h1>Life Style Courses</h1>
            ...
            <div className='main'>
                <div className='box'>
                {ContextData.filter((item) => item && item.id === 141).map((item, index) => {
            console.log(item);
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 142).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 143).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 144).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 145).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
...
<div className='BusinessSection3Inner'>
    <div>Reiki</div>
    <div>Energy Healing</div>
    <div>Chess</div>
    <div>Spiritual Healing</div>
    <div>Astrology</div>
    <div>Tarot Reading</div>
    <div>Hypnotherapy</div>
    <div>CopyWriting</div>
    <div>Watercolor Painting</div>
    <div>Google Ads</div>
    </div>
</div></div>
...
<div className='box1'>
                {ContextData.filter((item) => item && item.id === 146).map((item, index) => {
            console.log(item);
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 147).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 148).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 149).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 150).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 151).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 154).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
