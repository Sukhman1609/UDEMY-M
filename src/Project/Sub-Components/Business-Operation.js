    ...
    <div className='Business'>
      ...
      <NavLink to='/business/communication' className='sub-link'>Communication</NavLink>
        ...
        <div className='BusinessSection'>
            ...
            <div className='main'>
                <div className='box'>
                {ContextData.filter((item) => item && item.id === 39).map((item, index) => {
            console.log(item);
...
<div className='BusinessSection3Inner'>
    ...
    <div>Lean Six Sigma Yellow Belt Certified</div>
    <div>Lean Six Sigma Green Belt Certified</div>
    <div>Lean Six Sigma Black Belt Certified</div>
    <div>Virtual Assistant</div>
    <div>Artifical Intelligence</div>
    
    <div>Lean Six Sigma White Belt Certified</div>
    </div>
</div></div>
