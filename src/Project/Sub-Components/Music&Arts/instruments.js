...
function MusicArtsInstruments() {
  ...
  return (
    <div className='Business'>
      ...
      <div><h3>Music & Arts Courses &gt;</h3></div>
      <div className="sub-nav">
      <NavLink to='/musicarts/instruments' className='sub-link'  style={{marginLeft:'140px'}}>Instruments</NavLink>
        <NavLink to='/musicarts/production' className='sub-link'>Music Production</NavLink>
        <NavLink to='/musicarts/vocal' className='sub-link'>Vocal</NavLink>
        <NavLink to='/musicarts/software' className='sub-link'>Music Software</NavLink>
        <NavLink to='/musicarts' className='sub-link'>Music Techniques</NavLink>
        </div>
        </div>

        <div className='BusinessSection'>
            <div className='BusinessSectionHead'>
            <h1>Music & Arts Courses</h1>
            ...
            <div className='main'>
                <div className='box'>
                {ContextData.filter((item) => item && item.id === 195).map((item, index) => {
            console.log(item);
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 194).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 193).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 192).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 191).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
...
<div className='box1'>
                {ContextData.filter((item) => item && item.id === 185).map((item, index) => {
            console.log(item);
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 187).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 183).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 182).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 180).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 181).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 184).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
...
export default MusicArtsInstruments;
