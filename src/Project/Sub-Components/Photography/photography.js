...
function Photography() {
  ...
  return (
    <div className='Business'>
      ...
      <div><h3>Photography & Video Courses &gt;</h3></div>
      <div className="sub-nav">
      <NavLink to='/photography/digital' className='sub-link'  style={{marginLeft:'140px'}}>Digital Photography</NavLink>
        <NavLink to='/photography/video' className='sub-link'>Video Design</NavLink>
        <NavLink to='/photography' className='sub-link'>Photography</NavLink>
        <NavLink to='/photography/commerical' className='sub-link'>Commercial Photography</NavLink>
        <NavLink to='/photography/tools' className='sub-link'>Photography Tools</NavLink>
        </div>
        </div>

        <div className='BusinessSection'>
            <div className='BusinessSectionHead'>
            <h1>Photography & Video Courses</h1>
            ...
            <div className='main'>
                <div className='box'>
                {ContextData.filter((item) => item && item.id === 161).map((item, index) => {
            console.log(item);
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 162).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 163).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 164).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
    ...
    <div className='box'>
                {ContextData.filter((item) => item && item.id === 165).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='boxinner' >
            <NavLink to={`/detail/${item.id}`} ><img src={item && item.bollywoodimg} alt={item.name} className='subImg' /></NavLink>
             <p className='name' >{item.name}</p> 
...
<div className='box1'>
                {ContextData.filter((item) => item && item.id === 166).map((item, index) => {
            console.log(item);
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 167).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 168).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 169).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 170).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 171).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
    ...
    <div className='box1'>
                {ContextData.filter((item) => item && item.id === 174).map((item, index) => {
            console.log(item);
            return(   <div key={item.id} className='box1inner' >
                <div className='BSMain'>
